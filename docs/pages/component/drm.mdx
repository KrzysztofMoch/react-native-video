...
DRM Offline
In some cases, you’ll need DRM-protected video content available offline. We’ve built the Offline Video SDK to download, store, and manage HLS/DASH streams with or without DRM. To learn more, please see our Video Offline SDK documentation.
Prerequisite: use version 6 or 7 of react-native-video. If you’re still on version 5 or lower, contact us for assistance.
